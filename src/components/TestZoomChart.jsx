...
const initialState = {
 ...
 class TestZoomChart extends PureComponent {
  ...
  render() {
    ...
    return (
      <div className="highlight-bar-charts" style={{ userSelect: 'none', width: '100%' }}>
        <Button className="btn update" onClick={this.zoomOut.bind(this)} variant='contained' color='primary'>
          Zoom Out
        </Button>
